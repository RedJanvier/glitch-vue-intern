...
exports.default = {
  ...
  created: function created() {
    ...
    fetch("https://hirng-x2021.glitch.me/api").then(function (res) {
      return res.json();
    }).then(function (data) {
      console.log(data);
      var name = data.name,
      ...
      for (var media in social_media) {
        social_medias[media] = _this.generateLink(media, social_media[media]);
      }
      console.log("These are medias", social_medias);
      return _this.social_media = social_medias;
    }).catch(console.log);
  },
  data: function data() {
    return {
  ...
  methods: {
    generateLink: function generateLink(type, username) {
      switch (type) {
        case "instagram":
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('div',{staticClass:"content"},[_c('h1',[_vm._v(_vm._s(_vm.name))]),_vm._v(" "),_c('img',{attrs:{"alt":"main","src":"https://cdn.glitch.com/511b35f3-cc62-456b-9917-a7f7a573af3c%2Fmain.png?v=1610119233266"}}),_vm._v(" "),_vm._m(0),_vm._v(" "),_c('ul',{staticClass:"links"},_vm._l((_vm.social_media),function(link,propName){return _c('li',[_c('a',{attrs:{"href":link}},[_c('i',{class:[
              'fa',
              propName == 'instagram'
                ? 'fa-instagram'
                : propName == 'email'
                ? 'fa-envelope-square'
                : 'fa-' + propName + '-square' ]})])])}),0)])])}
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('ul',{staticClass:"navigation"},[_c('li',[_vm._v("Home")]),_vm._v(" "),_c('li',[_vm._v("About")]),_vm._v(" "),_c('li',[_c('img',{attrs:{"src":"https://cdn.glitch.com/511b35f3-cc62-456b-9917-a7f7a573af3c%2Fmain.png?v=1610119233266"}})]),_vm._v(" "),_c('li',[_vm._v("Gallery")]),_vm._v(" "),_c('li',[_vm._v("Contact")])])}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2155e63a", __vue__options__)
  } else {
    hotAPI.reload("data-v-2155e63a", __vue__options__)
  }
})()}
